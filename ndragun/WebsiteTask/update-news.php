					<!--START UPDATES-->
					<div class="news-list updates-news" style="display:none;">
						<ul class="news-box">
<?php
    ...
    if($data['status'] == 'ok'){     
       ...
       ?>
						...
						<div class="pages" style="display:none;" data-fn="pagination" data-config="items: .updates-news li;prev: .pages .prev;next: .pages .next;perPage:3;">
