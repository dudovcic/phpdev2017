					<!--START RECENT-->
					<div class="news-list recent-news">
	                    <ul class="news-box">
...
<?php
    ...
    if($data['status'] == 'ok'){     
       ...
       ?>
						...
						<div class="pages" style="display:none;" data-fn="pagination" data-config="items: .recent-news li;prev: .pages .prev;next: .pages .next;perPage:3;">
