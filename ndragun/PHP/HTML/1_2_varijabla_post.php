...
<body>
   ...
   <header>
       ...
       <form  method="POST" action="">
           ime <br/> 
           <input type="text" name="ime" value="" placeholder="Tvoje Ime" /> <br/>
           prezime: <br/> 
           <input type="text" name="prezime" value="" placeholder="Tvoje Prezime" /> <br/>
           <br/>
           spol: <br/> 
...
//POST PREGAZI GET U REQUESTA (NE KORISTI SE)
