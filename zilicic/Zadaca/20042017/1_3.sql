...
CREATE TABLE IF NOT EXISTS `cjenik` (
  `sifra_cjenika` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `clanovi` (
  `clanski_broj` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `film` (
  `sifra_filma` int(10) NOT NULL AUTO_INCREMENT,
  ...
  KEY `FK_film_zanr` (`sifra_zanra`),
  CONSTRAINT `FK_film_zanr` FOREIGN KEY (`sifra_zanra`) REFERENCES `zanr` (`sifra_zanra`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `posudba` (
  ...
  KEY `FK_posudba_film` (`sifra_filma`),
  KEY `FK_posudba_cjenik` (`sifra_cjenika`),
  CONSTRAINT `FK_posudba_cjenik` FOREIGN KEY (`sifra_cjenika`) REFERENCES `cjenik` (`sifra_cjenika`),
  CONSTRAINT `FK_posudba_clanovi` FOREIGN KEY (`clanski_broj`) REFERENCES `clanovi` (`clanski_broj`),
  CONSTRAINT `FK_posudba_film` FOREIGN KEY (`sifra_filma`) REFERENCES `film` (`sifra_filma`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `zanr` (
  `sifra_zanra` int(10) NOT NULL AUTO_INCREMENT,
